...
{
    /// <summary>
    /// 手机支付控件(V2.2) 银联加密公钥更新查询接口
    /// </summary>
    public class UnionPayMobileControlPayEncryptCertUpdateQueryRequest : IUnionPayRequest<UnionPayMobileControlPayEncryptCertUpdateQueryResponse>
    {
        /// <summary>
        /// 产品类型
        /// </summary>
