...
namespace Essensoft.AspNetCore.UnionPay.Utility
{
    ...
    public sealed class HttpClientEx : HttpClient
    {
        ...
        public async Task<ResponseContent> DoPostAsync(string url, IDictionary<string, string> parameters)
        {
            ...
            using (var responseContent = response.Content)
            {
                ...
                return new ResponseContent { ContentType = responseContent.Headers.ContentType.ToString().ToLower(), Content = content };
            }
        }
