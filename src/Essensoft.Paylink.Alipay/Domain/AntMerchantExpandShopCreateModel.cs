...
namespace Essensoft.Paylink.Alipay.Domain
{
    ...
    public class AntMerchantExpandShopCreateModel : AlipayObject
    {
        ...
        /// <summary>
        /// 营业执照图片 id 即通过 https://opendocs.alipay.com/apis/api_1/ant.merchant.expand.indirect.image.upload 接口上传图片后得到的 image_id。 蚂蚁门店管理场景可选。
        /// </summary>
        ...
        /// <summary>
        /// 营业执照授权函。其值为使用ant.merchant.expand.indirect.image.upload上传图片得到的一串oss key。 蚂蚁门店管理场景可选。
        /// </summary>
        ...
        /// <summary>
        /// 门头照 id，即通过 https://opendocs.alipay.com/apis/api_1/ant.merchant.expand.indirect.image.upload 接口上传图片后得到的 image_id。 蚂蚁门店管理场景可选。
        /// </summary>
