...
namespace Essensoft.AspNetCore.Payment.Alipay.Response
{
    ...
    public class AlipayOfflineMarketShopQuerydetailResponse : AlipayResponse
    {
        ...
        /// 门店修改时间
        /// </summary>
        [JsonProperty("gmt_shop_modified")]
        ...
        /// 其它资质证明图片集；支持多张，逗号分隔
        /// </summary>
        [JsonProperty("other_auth_images")]
        ...
        /// 经过加工后的门店收款二维码
        /// </summary>
        [JsonProperty("processed_qr_code")]
        ...
        /// 门店运营归属人uid
        /// </summary>
        [JsonProperty("provider_xiaoer_uid")]
