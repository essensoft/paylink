...
namespace Essensoft.AspNetCore.Payment.Alipay.Response
{
    ...
    public class AlipayMarketingCampaignDrawcampQueryResponse : AlipayResponse
    {
        ...
        /// 实时人群验证规则id，由支付宝配置
        /// </summary>
        [JsonProperty("trigger_user_rule_id")]
