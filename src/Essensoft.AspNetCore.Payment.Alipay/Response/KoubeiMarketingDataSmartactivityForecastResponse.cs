...
namespace Essensoft.AspNetCore.Payment.Alipay.Response
{
    ...
    public class KoubeiMarketingDataSmartactivityForecastResponse : AlipayResponse
    {
        ...
        /// 新增曝光数量 上限值
        /// </summary>
        [JsonProperty("increased_exposure_max")]
        ...
        /// 新增曝光数量 下限值
        /// </summary>
        [JsonProperty("increased_exposure_min")]
        ...
        /// 提升复购率区间上限
        /// </summary>
        [JsonProperty("repay_rate_range_max")]
        ...
        /// 提升复购率区间下限
        /// </summary>
        [JsonProperty("repay_rate_range_min")]
        ...
        /// 活动收益金额(分)区间上限值
        /// </summary>
        [JsonProperty("trade_amt_range_max")]
        ...
        /// 活动收益金额(分)区间下限值
        /// </summary>
        [JsonProperty("trade_amt_range_min")]
        ...
        /// 核销数量区间上限
        /// </summary>
        [JsonProperty("verify_count_range_max")]
        ...
        /// 核销数量区间下限
        /// </summary>
        [JsonProperty("verify_count_range_min")]
