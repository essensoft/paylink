...
namespace Essensoft.AspNetCore.Payment.Alipay.Domain
{
    ...
    public class InteligentVoucher : AlipayObject
    {
        ...
        /// 券的说明条款
        /// </summary>
        [JsonProperty("inteligent_clause_terms")]
        ...
        /// 延迟生效信息
        /// </summary>
        [JsonProperty("inteligent_delay_info")]
        ...
        /// 券使用说明描述列表
        /// </summary>
        [JsonProperty("inteligent_desc_detail_list")]
        ...
        /// 券的展示信息
        /// </summary>
        [JsonProperty("inteligent_display_config")]
        ...
        /// </summary>
        [JsonProperty("inteligent_item_info")]
        ...
        /// 券的使用规则信息
        /// </summary>
        [JsonProperty("inteligent_use_rule")]
