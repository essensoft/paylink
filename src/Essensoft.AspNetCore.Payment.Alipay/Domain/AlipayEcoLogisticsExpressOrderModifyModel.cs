...
namespace Essensoft.AspNetCore.Payment.Alipay.Domain
{
    ...
    public class AlipayEcoLogisticsExpressOrderModifyModel : AlipayObject
    {
        ...
        /// 产品类型变更原因，产品类型变更时选填。
        /// </summary>
        [JsonProperty("product_type_change_reason")]
        ...
        /// 站点投诉电话，快递站点接单时选填
        /// </summary>
        [JsonProperty("site_complain_tel")]
        public string SiteComplainTel { get; set; }

        /// <summary>
        /// 站点所在详细地址，快递站点接单时必填
        /// </summary>
        [JsonProperty("site_detail_addr")]
        public string SiteDetailAddr { get; set; }

        /// <summary>
        /// 站点负责人手机号，快递站点接单时必填
        /// </summary>
        [JsonProperty("site_leader_mobile")]
        public string SiteLeaderMobile { get; set; }

        /// <summary>
        /// 站点负责人，快递站点接单时必填
        /// </summary>
        [JsonProperty("site_leader_name")]
