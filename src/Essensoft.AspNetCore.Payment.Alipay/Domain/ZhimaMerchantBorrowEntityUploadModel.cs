...
namespace Essensoft.AspNetCore.Payment.Alipay.Domain
{
    ...
    public class ZhimaMerchantBorrowEntityUploadModel : AlipayObject
    {
        ...
        /// </summary>
        [JsonProperty("office_hours_desc")]
